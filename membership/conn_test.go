...
import (
	...
	nodeclientmock "github.com/maxpoletaev/kivi/noderpc/mock"
)
...
func TestCluster_Conn(t *testing.T) {
	...
	conf.Dialer = func(ctx context.Context, addr string) (noderpc.Client, error) {
		dialerCalled++
		return conn, nil
	}
...
func TestCluster_Conn_Concurrent(t *testing.T) {
	...
	clusterConf.Dialer = func(ctx context.Context, addr string) (noderpc.Client, error) {
	...
	connections := make([]noderpc.Client, concurrency)
