...
func (m *MockMemberRegistry) SelfID() membership.NodeID {
	m.ctrl.T.Helper()
...
func (mr *MockMemberRegistryMockRecorder) SelfID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SelfID", reflect.TypeOf((*MockMemberRegistry)(nil).SelfID))
}
